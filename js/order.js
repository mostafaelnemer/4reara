...
if(orderData){
    ...
    if(userData.type=='customer'){
        if(orderData.delegate_id){
            delegateHtml+='<div class="col-xs-3"><a href="#" class="single-delegate" data-id="'+orderData.delegate_id+'"><img style="width: 100%" src="'+((orderData.img_dir&&orderData.img)?SITEURL+orderData.img_dir+orderData.img:SITEURL+'img/Users/default_image.png')+'" class="img-circle" alt=""></a></div> <div class="col-xs-9"> <a href="#" class="single-delegate" data-id="'+orderData.delegate_id+'"><h4>name</h4></a> <ul class="list-unstyled list-inline star-rating"> ';
